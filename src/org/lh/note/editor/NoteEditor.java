...
public class NoteEditor extends Activity {
    ...
    private static final String[] PROJECTION =
        new String[] {
            CloudNotebook.Notes._ID,
            CloudNotebook.Notes.COLUMN_NAME_TITLE,
            CloudNotebook.Notes.COLUMN_NAME_NOTE
    };
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            if (uri != null && CloudNotebook.Notes.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                mCursor = null;
                ContentValues values = new ContentValues();
                values.put(CloudNotebook.Notes.COLUMN_NAME_NOTE, mOriginalContent);
